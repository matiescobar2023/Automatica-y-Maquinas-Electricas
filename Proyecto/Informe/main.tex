...
$G_1(s)$. Para representar este fenómeno, se simuló el sistema bajo las condiciones indicadas en \cref{condiciones simulacion dinamica de ceros}, exagerando
el efecto del cero llevandolo hacia el eje imaginario del plano complejo.

\begin{equation}
    \begin{cases}
        \mathbf{x}(0) &= \mathbf{0}\\
        v_{qs}(t) &\equiv 0\\
        T_l(t) &= 0 \rightarrow  \left(T_{lmax} = 6.28 \, N \cdot m\,; t = 0.3\,s\right)\\
	    z &= -50\,\frac{rad}{s}
    \end{cases}
