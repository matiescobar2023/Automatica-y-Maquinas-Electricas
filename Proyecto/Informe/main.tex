...
\begin{equation}
    \dot{\omega}_m(t) = \frac{3}{2} \frac{P_p i^r_{qs}(t)\left[\lambda'^r_m + (L_d - L_q) i^r_{ds}(t) \right]}{J_{eq}} - \frac{b_{eq}\omega_m(t)}{J_{eq}} 
    \label{ecuacion de estado 2}
\end{equation}
...
\begin{align}
    \dot{i}^r_{qs}(t) &=  \frac{-R_s(t) i^r_{qs}(t)}{L_q} - \frac{\omega_m(t) \left[\lambda'^r_m - L_d P_p i^r_{ds}(t)\right]}{L_q}\\
    \dot{i}^r_{ds}(t) &=  \frac{- R_s(t) i^r_{ds}(t)}{L_d} + \frac{L_q P_p i^r_{qs}(t)\omega_m(t)}{L_d}  \\ 
    \dot{i}_{0s}(t)   &= -\frac{1}{L_{ls}} R_s(t) i_{0s}(t)
    \label{ecuaciones de estado 3 4 y 5}
\end{align}

La última ecuación de estado se obtiene relacionando las \cref{balance termico estator} y \cref{potencia de perdidas} obteniendose:
\begin{equation}
    \dot{T}^\circ_s(t) = \frac{3}{2} \frac{R_s(t) \left[ i_{qs}^2(t) + i_{ds}^2(t) + 2 i_{0s}^2(t) \right]}{C_{ts}}
    \label{ecuacion de estado 6}
\end{equation}
...
\begin{equation}
    ...
    \begin{bmatrix} 
    \omega_m(t) \\ 
    \frac{3}{2} \frac{P_p i^r_{qs}(t)\left[\lambda'^r_m + (L_d - L_q) i^r_{ds}(t) \right]}{J_{eq}} - \frac{b_{eq}\omega_m(t)}{J_{eq}} \\ 
    \frac{-R_s(t) i^r_{qs}(t)}{L_q} - \frac{\omega_m(t) \left[\lambda'^r_m - L_d P_p i^r_{ds}(t)\right]}{L_q}\\ 
    \frac{- R_s(t) i^r_{ds}(t)}{L_d} + \frac{L_q P_p i^r_{qs}(t)\omega_m(t)}{L_d}  \\ 
    -\frac{1}{L_ls} R_s(t) i_{0s}(t)  \\ 
    \frac{3}{2} \frac{R_s(t) \left[ i_{qs}^2(t) + i_{ds}^2(t) + 2 i_{0s}^2(t) \right]}{C_{ts}}
    \end{bmatrix}
    + 
    \begin{bmatrix} 
    0 & 0 & 0 \\ 
...
\begin{equation}
    ...
    \begin{bmatrix}
        1 & 0 & 0 & 0 & 0 & 0
    \end{bmatrix}
    \begin{bmatrix} \theta_m \\ \omega_m \\ i^r_{qs} \\ i^r_{ds} \\ i_{0s} \\ T^\circ_s \end{bmatrix}
