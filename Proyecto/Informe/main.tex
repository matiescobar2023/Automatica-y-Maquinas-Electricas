...
Para el caso general en donde no se cumple la hipótesis $i^{r}_{ds}(0)=0$ , existe una dinámica residual en la corriente $i^{r}_{ds}$. Esta dinámica queda represantada con la ecuacion diferencial que obtenemos al reemplazar la ley de control mínima eq. \eqref{ecuacion determinacion ley de control minima} en eq. \eqref{ecuacion de estado ids}:
\begin{equation}
